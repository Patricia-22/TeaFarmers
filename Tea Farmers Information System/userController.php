...
$db = mysqli_connect('localhost', 'root', '', 'tea_farmers');
...
if (count($errors) == 0) {
    ...
    $query = "INSERT INTO admin (Name, username, password,PhoneNumber, emailAddress) 
          VALUES('$Name','$username', '$password','$number','$email')";
